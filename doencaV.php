...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary border">
            ...
            style="opacity: 0.8"
          /> -->
                <span class="brand-text font-weight-light">Gestão Hospitalar</span>
            </a>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <section class="col-lg-12 connectedSortable">
                                <table class="table table-striped table-bordered">
                                    ...
                                    $sql_doenca = "SELECT * FROM doença";
                                    $resulta = mysqli_query($conn, $sql_doenca);
                                    ...
                                    if ($resulta->num_rows > 0) {
                                        while ($row = $resulta->fetch_assoc()) {
                                            ...
                                            echo '<td>' . $row['nCientifico'] . '</td>';
                                            echo '<td>' . $row['gravidade'] . '</td>';
                                            echo '</tr>';
                                        }
                                    }
                                ...
                                <div id="abaixo" class="row">
                                    <div class="col-sm-2" style="margin-left: 50px;">
                                        <a href="cadDoenca.html" button type="button" class="btn btn-primary">Cadastrar</a>
                                    </div>
                                </div>
                            </section>
                        </div>
